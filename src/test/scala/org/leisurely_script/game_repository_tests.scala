...
class StaticLocalGameRepoTests extends FunSuite {
  test("The TicTacToe factory should work.") {
    ...
    assert(tie(0).board.nInARow(0, xPiece) == false)
    assert(tie(1).board.nInARow(0, xPiece) == false)
    assert(tie(2).board.nInARow(0, xPiece) == false)
    assert(tie(3).board.nInARow(0, xPiece) == false)
    assert(tie(4).board.nInARow(0, xPiece) == false)
    assert(tie(5).board.nInARow(0, xPiece) == false)
    assert(tie(6).board.nInARow(0, xPiece) == false)
    assert(tie(7).board.nInARow(0, xPiece) == false)
    assert(tie(8).board.nInARow(0, xPiece) == false)
    assert(tie(9).board.nInARow(0, xPiece) == false)

    assert(tie(0).board.nInARow(0, oPiece) == false)
    assert(tie(1).board.nInARow(0, oPiece) == false)
    assert(tie(2).board.nInARow(0, oPiece) == false)
    assert(tie(3).board.nInARow(0, oPiece) == false)
    assert(tie(4).board.nInARow(0, oPiece) == false)
    assert(tie(5).board.nInARow(0, oPiece) == false)
    assert(tie(6).board.nInARow(0, oPiece) == false)
    assert(tie(7).board.nInARow(0, oPiece) == false)
    assert(tie(8).board.nInARow(0, oPiece) == false)
    assert(tie(9).board.nInARow(0, oPiece) == true)
