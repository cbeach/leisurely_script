...
abstract case class Function1CallExpression[-T1, +R](arg1:T1)
  extends GameExpression[R] {}
abstract case class Function2CallExpression[-T1, -T2, +R](arg1:T1, arg2:T2)
  extends GameExpression[R] {}
abstract case class Function3CallExpression[-T1, -T2, -T3, +R](arg1:T1, arg2:T2, arg3:T3)
  extends GameExpression[R] {}
abstract case class Function4CallExpression[-T1, -T2, -T3, -T4, +R]
  (arg1:T1, arg2:T2, arg3:T3, arg4:T4) extends GameExpression[R] {}
abstract case class Function5CallExpression[-T1, -T2, -T3, -T4, -T5, +R]
