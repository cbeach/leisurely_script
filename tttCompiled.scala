package org.beachc.leisurely.game.implementations
...
package object TicTacToe {
  ...
  case class TicTacToe() extends GameState("TicTacToe") {
    ...
    val inputs: List[ButtonInputImplementation[Discrete2DCoordinate]] = List(
      ButtonInputImplementation(this, Discrete2DCoordinate(0, 0), legalMoves), 
      ButtonInputImplementation(this, Discrete2DCoordinate(0, 1), legalMoves), 
      ButtonInputImplementation(this, Discrete2DCoordinate(0, 2), legalMoves),
      ButtonInputImplementation(this, Discrete2DCoordinate(1, 0), legalMoves), 
      ButtonInputImplementation(this, Discrete2DCoordinate(1, 1), legalMoves), 
      ButtonInputImplementation(this, Discrete2DCoordinate(1, 2), legalMoves),
      ButtonInputImplementation(this, Discrete2DCoordinate(2, 0), legalMoves), 
      ButtonInputImplementation(this, Discrete2DCoordinate(2, 1), legalMoves), 
      ButtonInputImplementation(this, Discrete2DCoordinate(2, 2), legalMoves))
...
object Main {
  def gameSim(simulation: Stack[Int])   = {
    import org.beachc.leisurely.runTime.Interfaces.TicTacToe_CLIInterface
